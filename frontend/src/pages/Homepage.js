  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex">
        ...
        {algorithmState && (
          <motion.div 
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20"
            initial={{ scale: 0, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={{ duration: 0.8, delay: 0.5 }}
          >
            <div className="text-center text-white">
              <h3 className="font-semibold mb-2">Algorithm Emotional State</h3>
              <div 
                className="w-16 h-16 mx-auto mb-2 rounded-full border-2 animate-pulse"
                style={{ 
