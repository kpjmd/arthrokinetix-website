...
import { Share2, Twitter, Linkedin, Facebook, Mail, MessageCircle, Copy, Check, X } from 'lucide-react';
                  ...
                  {platforms.map((platform) => {
                    ...
                    return (
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="flex flex-col items-center p-3 border border-gray-200 rounded-lg hover:border-gray-300 transition-colors group"
                        style={{ '--platform-color': platform.color }}
                      >
                        <IconComponent 
                          className="w-6 h-6 mb-2 group-hover:text-[var(--platform-color)] transition-colors" 
